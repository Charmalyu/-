...
public class LogAdvice {
    ...
    @AfterReturning("execution(* com.imooc.sm.controller.*.*(..)) && !execution(* com.imooc.sm.controller.SelfController.*(..)) && !execution(* com.imooc.sm.controller.*.to*(..)) && !execution(* com.imooc.sm.controller.LogController.*(..))")
    ...
    @AfterReturning("execution(* com.imooc.sm.controller.SelfController.login(..))")
